...
public:
    ...
    TestSom(char* fileData, char* fileSolution, char* fileStats, ConfigParams params) :
        fileData(fileData),
...
//            md.densityMap[y][x] = md.densityMap[y][x] <= MIN_MESH_DISPARITY ? 0 : md.densityMap[y][x];
        ...
        // Detect Color Edges
//        K_detectColorEdges<sobelEdge>(md_gpu);
//        setEdgeAndWriteDensityImage(md_gpu, fileData);
