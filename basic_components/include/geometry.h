...
public:
    ...
    DEVICE_HOST inline Point operator-(const Vector& v) const;//corps place après class Vector
    //! Soustraction vecteur ou translation de vecteur -v
    DEVICE_HOST inline Point operator*(const GLfloat& f) const {
...
DEVICE_HOST inline bool ifAtSameSideBis(const Point_2& p,
                  const Point_2& p0,
                  const Point_2& p1,
                  const Point_2& p2)
{
...
//! HW 23/03/15
//! To decide if p and p0 are at the same side of line p1-p2
DEVICE_HOST inline bool ifAtSameSide(const Point_2& p,
                  const Point_2& p0,
                  const Point_2& p1,
                  const Point_2& p2)
{
