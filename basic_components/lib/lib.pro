...
#wb.Q local includee parallel_EMST, for intergrating with JCC's component
  INCLUDEPATH  += ../../parallel_emst/parallel_EMST/include/componentsEMST/include
